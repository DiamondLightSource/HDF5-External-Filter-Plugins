...
int main() {
    int return_code = 1;
    unsigned int lz4_opt[] = {0, BSHUF_H5_COMPRESS_LZ4};
    unsigned int zstd_opt[] = {0, BSHUF_H5_COMPRESS_ZSTD, 3}; // compression level 0-ZSTD_maxCLevel() (0=no compression, higher values => smaller size, max=22 since 0.6.0 to 1.5.2, default 3)
